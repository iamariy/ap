...
public class Main_EX2_PM_3_1_D {
    public static class PacmanGUI extends JFrame implements KeyListener {
        ...
        final long maxTimeMillis = 60 * 1000;
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (timeElapsed >= maxTimeMillis) {
                JOptionPane.showMessageDialog(this, "The time ended." + (timeElapsed / 1000) +"s");
                System.exit(0);
            }

            if (score >= maxScore) {
                JOptionPane.showMessageDialog(this, " Final score:" + score + "\nGame ended successfully!"+
                        "\ntime" + (timeElapsed / 1000) + "s");
                System.exit(0);
            }
